...
t1 = linspace(0, 2, 100); % 시나리오 1, 2, 4용 (2초, 100샘플)
...
scenarios = { 
    ...
    % 시나리오 3: 200pts 리사주 패턴 (2초) - 시작점 theta1=0, theta2=pi/2
    'Scenario 3: Full Lissajous (T=2s, 200pts)', 2*pi*1*t2, 2*pi*0.5*t2 + pi/2, t2;
    
    % 시나리오 4: 100pts 리사주 패턴 (2초) - 시작점 theta1=0, theta2=pi/2
    'Scenario 4: Partial Lissajous (T=2s, 100pts)', 2*pi*1*t1, 2*pi*0.5*t1 + pi/2, t1 
